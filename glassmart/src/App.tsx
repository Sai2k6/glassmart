...
function App() {
  ...
  return <div className="app">{renderHeader()}
    ...
    {page === "login" && <main className="page-container auth-page"><div className="auth-card"><p className="eyebrow">GLASSMART ACCOUNT</p><h1>{authMode === "login" ? "Welcome back" : "Create your account"}</h1></div></main>}
