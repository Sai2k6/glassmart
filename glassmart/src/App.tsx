...
export function App() {
  ...
  return (
    <div className="app">
        ...
        <main className="storefront-home">
          ...
          <section className="storefront-hero">
            <div className="storefront-hero-copy">
              <p className="storefront-kicker">PREMIUM ARCHITECTURAL HARDWARE</p>
              <h1>Quality Hardware for Modern Spaces</h1>
              <p>
                Discover premium door, window, cabinet & furniture hardware from leading brands.
                Explore extensive variants in stainless steel, brass and aluminium finishes.
              </p>
            ...
            <div className="storefront-hero-image">
              <img src={glassProduct} alt="Glassmart hardware showcase" />
              <div className="storefront-hero-tag">
                <div>
                  <strong>Architectural Excellence</strong>
                  <span>Top brands · Guaranteed materials · Reliable supply</span>
                </div>
              </div>
            </div>
          </section>

          {/* WHY CHOOSE US / BENEFIT STRIP */}
          <section className="storefront-benefits">
            <div>
              <span className="benefit-icon">🛡️</span>
              <div>
                <strong>Quality Hardware</strong>
                <span>Tested for durability & smooth operation</span>
              </div>
            </div>
            <div>
              <span className="benefit-icon">🏷️</span>
              <div>
                ...
                <span>Jyothi, KAR, Ebco, Jai Shankar & more</span>
              </div>
            </div>
            <div>
              <span className="benefit-icon">📐</span>
              <div>
                <strong>Multiple Sizes & Finishes</strong>
                <span>SS, Satin, Antique, Gold & Matt options</span>
              </div>
            </div>
            <div>
              <span className="benefit-icon">🚚</span>
              <div>
                ...
                <span>Direct dispatch with order tracking</span>
              </div>
            </div>
          </section>

          {/* SHOP BY CATEGORY GRID (12 CORE CATEGORIES) */}
          <section className="section">
            <div className="section-heading">
              <p className="eyebrow">BROWSE CATALOG</p>
              <h2>Shop by Category</h2>
              <p>Find the exact fittings needed for doors, windows, wardrobes & cabinets.</p>
            </div>
            <div className="storefront-category-grid">
              {CORE_CATEGORIES.map(cat => (
                ...
                >
                  <span className="storefront-category-icon">{cat.icon}</span>
                  <div>
                    <h3>{cat.name}</h3>
                    <p>{cat.description}</p>
          ...
          <section className="section storefront-products-strip">
            <div className="section-heading">
              <p className="eyebrow">BESTSELLERS & POPULAR</p>
              <h2>Featured Hardware Items</h2>
              <p>Top choice fittings specified by contractors, architects & homeowners.</p>
            </div>
            <div className="products-grid">
              {allCatalogCards.slice(0, 8).map((item, idx) => {
                const itemKey = `feat-${item.brand}-${item.categoryName}-${idx}`;
                ...
                return (
                  <article className="product-card" key={itemKey}>
                    ...
                    <div className="product-info">
                      ...
                      <h3 onClick={() => openProductDetail(item)}>{item.brand} {item.categoryName}</h3>
            ...
            <div className="storefront-centered-action">
              <button
                className="secondary-btn view-all-btn"
                onClick={() => {
                  setSelectedCategory("All");
                  navigate("products");
                }}
          ...
          <section className="section brands-section">
            <div className="section-heading">
              <p className="eyebrow">TRUSTED MANUFACTURERS</p>
              <h2>Shop by Brand</h2>
              <p>Industry-standard hardware brands with certified raw material purity.</p>
            </div>
            <div className="brand-grid">
              {ALL_BRANDS.slice(0, 10).map(brand => (
                <button
                  key={brand}
                ...
                >
                  <strong>{brand}</strong>
                  <small>Explore series</small>
                </button>
              ))}
            </div>
          </section>

          {/* SERVICE / CUSTOM QUOTE BANNER */}
          <section className="section storefront-service-banner">
            <div>
              <p className="eyebrow">PROJECT & SITE SUPPORT</p>
              <h2>Require Bulk Quantities or Custom Specifications?</h2>
              <p>
                Get direct B2B pricing, project estimations, and custom architectural hardware quotes.
              </p>
            </div>
      ...
      {/* 2. PRODUCT LISTING CATALOG PAGE */}
      {page === "products" && (
      ...
      {page === "services" && (
        <main className="services-quote-page">
          <div className="services-quote-intro">
            <p className="services-quote-eyebrow">OUR SERVICES</p>
            <h1>Request a Project Quote</h1>
            <p>Need custom glass partitions, bulk hardware supply, or specialized fittings?</p>
          </div>

          <div className="services-quote-card">
            <div className="services-quote-copy">
              <p className="services-quote-eyebrow">B2B & ARCHITECTURAL SUPPORT</p>
              <h2>Tell Us Your Requirements</h2>
              <p>
                Our technical hardware specialist will review your schedule of finishes and provide
                a formal quotation.
              </p>
            </div>
            ...
            <form
              ...
              onSubmit={async e => {
                ...
                if (
                  ...
                  setEnquiryMessage("Please complete all required fields.");
                  return;
                }
                ...
                if (error) setEnquiryMessage(error.message);
                  ...
                  setEnquiryMessage("Enquiry submitted successfully! Our team will contact you.");
            ...
            >
              ...
              <label>
                ...
                <input
                  value={enquiry.phone}
                  onChange={e => setEnquiry(v => ({ ...v, phone: e.target.value }))}
              ...
              <label>
                ...
                <input
                  type="email"
                  value={enquiry.email}
                  onChange={e => setEnquiry(v => ({ ...v, email: e.target.value }))}
              ...
              <label>
                ...
                <select
                  ...
                  onChange={e => setEnquiry(v => ({ ...v, service: e.target.value }))}
                >
                  <option value="">Select requirement category</option>
                  <option value="Door Hardware">Door Hardware Supply</option>
                  <option value="Window Hardware">Window Hardware & Stays</option>
                  <option value="Cabinet & Wardrobe Fittings">Cabinet & Wardrobe Fittings</option>
                  <option value="Glass Partition">Glass Partition Hardware</option>
                  <option value="Bulk Project Supply">Bulk Project Supply</option>
                </select>
              </label>

              <label className="services-quote-requirements">
                Requirements & Quantities
                <textarea
                  value={enquiry.requirements}
                  onChange={e => setEnquiry(v => ({ ...v, requirements: e.target.value }))}
                  placeholder="Describe your project, required quantities, materials or finishes..."
                />
              </label>

              <div className="services-quote-submit">
                <button className="primary-btn" type="submit" disabled={enquiryLoading}>
                  {enquiryLoading ? "Submitting..." : "Submit Project Enquiry"}
                </button>
              </div>
              ...
              {enquiryMessage && (
                <div
                  className={
                    enquiryMessage.toLowerCase().includes("success")
                      ? "form-success services-quote-message"
                      : "form-error services-quote-message"
                  }
                >
                  {enquiryMessage}
                </div>
